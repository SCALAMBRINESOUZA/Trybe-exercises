...
divUm.addEventListener('selectstart', () => {
	divUm.innerHTML = input.value;
 	divUm.className = 'tech';
	divDois.removeAttribute('class');
	divTres.removeAttribute('class');
});

divDois.addEventListener('selectstart', () => {
	divDois.innerHTML = input.value;
	divDois.className = 'tech';
	divUm.removeAttribute('class');
	divTres.removeAttribute('class');
});

divTres.addEventListener('selectstart', () => {
	divTres.innerHTML = input.value;

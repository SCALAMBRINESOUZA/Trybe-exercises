...
// const FlName = (FirstName, lastName) => `${FirstName} ${lastName}`;

// let names = FlName('carlos', 'henrique')
...
const showName = Map.getUser((user) => `Hello My name is ${user.userToReturn.firstName} ${user.userToReturn.lastName}`);
